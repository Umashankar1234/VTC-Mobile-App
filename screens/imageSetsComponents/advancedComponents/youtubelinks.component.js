...
export const YoutubeLinksScreen = ({ route, navigation }) => {
  ...
  const onSubmit = (data) => {
    ...
    data.tourId = tourid;
    postMethod("save-youtube-links", data).then((res) => {
      if (res.length > 0) {
            ...
            <View style={styles.formWrapCard}>
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #1"
                    label="You Tube link #1"
                ...
                name="youtubeurl1"
                rules={{
                  required: { value: true, message: "Link 1 is required" },
                }}
              />
              {errors.youtubeurl1 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl1?.message}
                </Text>
              )}
              <Controller
                control={control}
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #2"
                    label="You Tube link #2"
                    style={styles.formControl}
                    textStyle={styles.textInputStyle}
                    onBlur={onBlur}
                    onChangeText={(value) => onChange(value)}
                ...
                name="youtubeurl2"
                rules={{
                  required: { value: true, message: "Link 2 is required" },
                }}
              />
              {errors.youtubeurl2 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl2?.message}
                </Text>
              )}
              <Controller
                control={control}
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #3"
                    label="You Tube link #3"
                    style={styles.formControl}
                    textStyle={styles.textInputStyle}
                    onBlur={onBlur}
                    onChangeText={(value) => onChange(value)}
                ...
                name="youtubeurl3"
                rules={{
                  required: { value: true, message: "Link 3 is required" },
                }}
              />
              {errors.youtubeurl3 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl3?.message}
                </Text>
              )}
              <Controller
                control={control}
                ...
                name="caption3"
                rules={{
                  required: { value: true, message: "Caption 3 is required" },
                }}
              />
              {errors.caption3 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.caption3?.message}
                </Text>
              )}
              <Divider style={{ marginVertical: 10 }} />
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #4"
                    label="You Tube link #4"
                    style={styles.formControl}
                    textStyle={styles.textInputStyle}
                    onBlur={onBlur}
                    onChangeText={(value) => onChange(value)}
                ...
                name="youtubeurl4"
                rules={{
                  required: { value: true, message: "Link 4 is required" },
                }}
              />
              {errors.youtubeurl4 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl4?.message}
                </Text>
              )}
              <Controller
                control={control}
                ...
                name="caption4"
                rules={{
                  required: { value: true, message: "Caption 4 is required" },
                }}
              />
              {errors.caption4 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.caption4?.message}
                </Text>
              )}
              <Divider style={{ marginVertical: 10 }} />
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #5"
                    label="You Tube link #5"
                    style={styles.formControl}
                    textStyle={styles.textInputStyle}
                    onBlur={onBlur}
                    onChangeText={(value) => onChange(value)}
                ...
                name="youtubeurl5"
                rules={{
                  required: { value: true, message: "Link 5 is required" },
                }}
              />
              {errors.youtubeurl5 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl5?.message}
                </Text>
              )}
              <Controller
                control={control}
                ...
                name="caption5"
                rules={{
                  required: { value: true, message: "Caption 5 is required" },
                }}
              />
              {errors.caption5 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.caption5?.message}
                </Text>
              )}
              <Divider style={{ marginVertical: 10 }} />
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <Input
                    placeholder="You Tube link #6"
                    label="You Tube link #6"
                    style={styles.formControl}
                    textStyle={styles.textInputStyle}
                    onBlur={onBlur}
                    onChangeText={(value) => onChange(value)}
                ...
                name="youtubeurl6"
                rules={{
                  required: { value: true, message: "Link 6 is required" },
                }}
              />
              {errors.youtubeurl6 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.youtubeurl6?.message}
                </Text>
              )}
              <Controller
                control={control}
                ...
                name="caption6"
                rules={{
                  required: { value: true, message: "Caption 6 is required" },
                }}
              />
              {errors.caption6 && (
                <Text style={styles.errorMsg} status="danger">
                  {errors?.caption6?.message}
                </Text>
              )}
              <Divider style={{ marginVertical: 10 }} />
