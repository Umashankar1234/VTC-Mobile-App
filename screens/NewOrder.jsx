...
import StepOne from "./neworder/StepOne";
import StepTwo from "./neworder/StepTwo";
import { useIsFocused } from "@react-navigation/native";
import StepThree from "./neworder/StepThree";
import StepFour from "./neworder/StepFour";

const NewOrder = ({ route }) => {
  const continueOrder = route.params?.continueOrder;
      ...
      <SafeAreaView style={styles.AndroidSafeArea}>
        ...
        <Layout style={styles.container}>
          ...
          <View style={styles.mainHeading}>
            ...
            <Text category="h4" status="basic" style={styles.secSubHeading}>
              RE Marketing Made EZ!
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  subPackageContainer: { marginHorizontal: 16, width: 120, marginVertical: 16 },
  subPackagesContainer: { alignContent: "center", justifyContent: "center" },
  subPackageImage: {
    height: 100,
    width: 100,
  },
  subPackageImageContainer: {
    alignContent: "center",
    justifyContent: "center",
    textAlign: "center",
    margin: "auto",
  ...
  subPackageTitle: { fontWeight: 500 },
  subPackageBtnContainer: {
    flex: 1,
    flexDirection: "row",
    // justifyContent: "center",
    alignItems: "center",
  },
  packageContainer: { marginVertical: 4 },
  labelHolder: { flexDirection: "row", marginBottom: 8 },
  labelHeading: { fontWeight: "bold" },
  labelsContainer: { padding: 20 },
  packageDesc: {
    fontWeight: "bold",
  },
});
